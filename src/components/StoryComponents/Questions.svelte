...
<section class="py-20 ">
    <div class="container max-w-6xl mx-auto">
        <h2 class="text-5xl font-bold py-4 tracking-tight font-baskerville text-center">~ Key Questions ~</h2>
        <p class="mt-2 text-lg mx-auto py-6 w-2/3 text-center ">{story.questionsIntro}</p>
        <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">

            <div class="boxes relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden  sm:rounded-xl">
                <div class="p-3 icon rounded-full">
                ...
                <p class="text-base text-center">{story.q[0][1]}</p>
            </div>

            <div class="boxes flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4  sm:rounded-xl">
                <div class="p-3 icon rounded-full">
                ...
                <p class="text-base text-center">{story.q[0][2]}</p>
            </div>
            ...
            <div class="boxes flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4  sm:rounded-xl">
                ...
                <p class="text-base text-center">{story.q[0][3]}</p>
            </div>

            <div class="boxes flex flex-col items-center justify-between col-span-6 px-8 py-12 space-y-4  sm:rounded-xl">
                <div class="p-3 icon rounded-full">
                ...
                <p class="text-base text-center">{story.q[0][4]}</p>
            </div>
            ...
            <div class="boxes flex flex-col items-center justify-between col-span-6 px-8 py-12 space-y-4  sm:rounded-xl">
                ...
                <p class="text-base text-center">{story.q[0][5]}</p>
            </div>
